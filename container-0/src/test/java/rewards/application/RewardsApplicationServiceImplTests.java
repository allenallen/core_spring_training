...
public class RewardsApplicationServiceImplTests {
	...
	public void setUp() throws Exception {
		org.slf4j.LoggerFactory.getLogger(this.getClass()).info("Testing...");
	...
	// TODO 03: Remove the @Ignore annotation below. Run this JUnit test.
	// This test will pass if you have done the previous TODOs correctly.
	@Ignore
	@Test
