...
@Entity
@Table(uniqueConstraints = { @UniqueConstraint(columnNames = { "productId", "cartId" }) })
public class CartItem {
	...
	// TODO 08b: Map many-to-one relationship/association to the cart this item
	// belongs to
	@ManyToOne
