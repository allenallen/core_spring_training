 ...
 * allows JNDI to be used stand-alone in a test.
 * <p>
...
public class SimpleJndiHelper implements BeanFactoryPostProcessor {
	...
	protected Logger logger = LoggerFactory.getLogger(SimpleJndiHelper.class);

	public void doJndiSetup() {
		System.setProperty(Context.INITIAL_CONTEXT_FACTORY,
				"org.osjava.sj.SimpleContextFactory");
		// Avoid a path that has a META-INF folder
		System.setProperty("org.osjava.sj.root", "target/classes/rewards");
		...
		try {
			...
			logger.error("JNDI Registration error", ex);
			System.exit(0);
		}
